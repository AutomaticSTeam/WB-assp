$(function(){
	...
	$("#saveBtn").click(function(){
		var framesName=$("#framesName").val();
		if(framesName!=""&&framesName!=null){
			$.ajax({
				url:rootPath+"/console/frame/editFramesOne.do",
				type:"post",
				datatype:"json",
	...
	var framesId=$("#framesId").val();
	if(framesId==""&&framesId==null){
		//添加图片按钮事件
		...
		if($("#framesAttachmentImg").val()==""||$("#framesAttachmentImg").val()==null){
			$("#thumbImgId").click(function(){
				uploadImg();
			});
		}
