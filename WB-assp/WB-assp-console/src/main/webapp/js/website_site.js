...
var QUERY_MODULE_PATH  = rootPath+'/template/loadDynamicModuleDatas.do'; // 查询框架链接
			...
			if(url != 'null' && url != null && url != ""){ // 导航不为空跳转
				...
				switch(type){
					...
					case 'article':
						...
						break;
					case 'picture':
						Site.href(QUERY_ROOT_PATH + 'loadContentPageId.do?pictureId=' + id ,"_blank");
						break;
					case 'media':
						Site.href(QUERY_ROOT_PATH + 'loadContentPageId.do?mediaId=' + id ,"_blank");
						break;
				}
			}
		},
