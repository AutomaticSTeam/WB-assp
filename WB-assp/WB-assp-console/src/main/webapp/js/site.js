$(function() {
	...
	function nav() {
		...
		if($li.length>7){
			...
			$(".ulWrap").css({"overflow":"hidden","position":"relative","width":$li.outerWidth()*7+1});
...
(function($) {
	$.fn.slider = function(options) {
		...
		var setCss = function() {
			...
			$productListDiv.parent().parent().find('.slider-page').remove();
		...
		var operation = function() {
			...
			var navWidth = $nav.outerWidth()+6; // 获取每一张图宽度
