...
<script type="text/javascript" src="<%=rootPath%>/js/frame/editFrame.js"></script> 
			...
			<div class="main-content" >
				<div class="form">
					...
					<div class="form-item">
						<label>板式描述</label>
						<div class="box-input">
							<%-- <input class="inputText" name="frameDesc"  id="frameDesc" type="text" value="${reasult.frameDesc}" datatype="s1-50"/> --%>
