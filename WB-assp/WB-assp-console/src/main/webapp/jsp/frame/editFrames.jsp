...
<script type="text/javascript" src="<%=rootPath%>/js/frame/editFrames.js"></script> 
					...
					<div class="form-item">
						...
						<div class="box-input">
							<select class="inputText" name="framesType"  id="framesType">
								<option value="0" ${reasult.framesType == 0 ? 'selected' : ''}>预置框架</option>
								<option value="1" ${reasult.framesType == 1 ? 'selected' : ''}>自定义框架</option>
							</select>
						</div>
					</div>
