         ...
         <form class="form-horizontal" role="form">
            <!--  <fieldset> -->
                 <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_host">模块名称</label>
                    <div class="col-sm-4">
...
<script type="text/javascript" src="<%=rootPath%>/jsp/module/js/managerModule.js"></script>
