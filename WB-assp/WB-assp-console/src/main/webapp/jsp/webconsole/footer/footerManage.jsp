				 ...
				 <form action="" method="post" id="moduleTmplForm">
					...
					<div class="search">
						<div class="" style="float: right;">
							<div class="btn-item">
								<a href="<%= rootPath%>/jsp/webconsole/footer/createOrEditFooter.jsp" class="btn btn-border-gray border-gray-new dib batchModifyBtn">新增</a>
								<a href="javascript:;" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="footer-edit">编辑</a>
								<a href="javascript:;" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="footer-del">删除</a>
								<!-- <a href="javascript:;" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="footer-preview">预览</a> -->
							</div>
						</div>
					</div><!--search-->
					</form>
					<div class="table" id="footer-table"></div><!--table-->
				</div><!--main-body-->
			</div><!--main-content-->
