	...
	<div id="articleTypeDiv"  class="oneEditPop" style="display:none">
	     	<div class="pop-form m-a">
					<div class="popForm-item">
						<label>分类名称：</label>
						<div class="label-con">
							<input class="inputText" type="text" name="articleTypeName"  id="articleTypeName" />
						</div>
					</div>
					<div class="popForm-item">
						<label>所属类别：</label>
						...
						<input class="inputText" type="text" name="articleTypePid_0"  id="articleTypePid_0" readonly="readonly" onclick="$formatToZtree.selecteTree('${pageContext.request.contextPath }','00',0,null,null,null,ArticleTypeQueryAll.articleTypeToZtree,false)"/>
						</div>
					</div>
				</div>
	</div>
