...
var NAVSAVEURL = '<%=rootPath%>/template/modifyTempLateNav.do';
var GETNAVURL = '<%=rootPath%>/template/queryTempLateNav.do';
var ADDNAVURL = '<%=rootPath%>/template/addTempLateNav.do';
var navManage = {
		id: "navFun",
		templateId: null,
		footerId: null,
		...
		initialize: function(){
			...
			if(navManage.id == 'footerFun'){// 站脚编辑初始化参数
				...
				NAVSAVEURL = "<%=rootPath%>/template/modifyFooterNav.do";
				GETNAVURL = "<%=rootPath%>/template/queryFooterNav.do";
				ADDNAVURL = "<%=rootPath%>/template/addFooterNav.do";
		...
		edit: function(id){
			...
			navManage.tempLayerIndex = layer.open({  
	            ...
	            maxmin: true,  
	            title: [title_, false],  
	            content: "<%=rootPath%>/jsp/template/manage/pop/editNavPop.jsp",
