...
<script type="text/javascript" src="<%=rootPath%>/jsp/user/js/permissionList.js"></script> 
				 ...
				 <form action="" method="post" id="moduleTmplForm">
					...
					<div class="search">
						<div class="" style="float: right;">
							<div class="btn-item">
								<a href="javascript:;" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="module-add">新增</a>
