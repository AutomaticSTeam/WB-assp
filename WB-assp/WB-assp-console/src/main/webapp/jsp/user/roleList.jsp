...
<script type="text/javascript" src="<%=rootPath%>/jsp/user/js/roleList.js"></script> 
				 ...
				 <form action="" method="post" id="moduleTmplForm">
					...
					<div class="search">
						<div class="search-item" style="margin-right:0px;">
							<label>角色名称：</label>
							<div class="box-input">
								<input class="inputText w180" name="roleName"  id="roleName" type="text" />
							</div>
							<label>角色编码：</label>
							<div class="box-input">
								<input class="inputText w180" name="roleCode"  id="roleCode" type="text" />
							</div>
							<a href="javascript:;" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="search">查询</a>
						</div>
						<div class="" style="float: right;">
							<div class="btn-item">
								<a href="<%= rootPath%>/jsp/user/addRole.jsp" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="module-add">新增</a>
