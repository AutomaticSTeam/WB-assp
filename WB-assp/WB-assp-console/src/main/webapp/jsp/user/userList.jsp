...
<script type="text/javascript" src="<%=rootPath%>/jsp/user/js/userList.js"></script> 
				 ...
				 <form action="" method="post" id="moduleTmplForm">
					...
					<div class="search">
						<div class="search-item">
							<label>用户账号搜索：</label>
							<div class="box-input">
								<input class="inputText w180" name="userName"  id="userName" type="text" />
							</div>
						</div>
						<div class="" style="float: right;">
							<div class="btn-item">
								<a href="<%= rootPath%>/jsp/user/addUser.jsp" class="btn btn-border-gray border-gray-new dib batchModifyBtn" id="module-add">新增</a>
