...
public class TemplateFooterServiceImpl implements ITemplateFooterService {
	...
	public int queryCountByExample(TemplateFooter example) {
		Example templateFooterExample = new Example(TemplateFooter.class);
		return templateFooterMapper.selectCountByExample(templateFooterExample);
	}

	@Override
	public List<TemplateFooter> queryByExample(TemplateFooter example) {
		Example templateFooterExample = new Example(TemplateFooter.class);
		return templateFooterMapper.selectByExample(templateFooterExample);
	}

	@Override
	public int insertReturnKey(TemplateFooter templateFooter) {
		return templateFooterMapper.insertReturnKey(templateFooter);
	}
