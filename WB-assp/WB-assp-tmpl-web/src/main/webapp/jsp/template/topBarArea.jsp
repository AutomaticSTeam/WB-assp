			...
			<div class="topBarArea-fixed">
				<div class="w">
					<ul class="topBarArea-nav fl">
						...
						<li><a href="<%=rootPath%>/jsp/webconsole/siteConsole.jsp?templateId=${tempalte.templateId}&columnsId=${columnsId}">网站管理</a><span>|</span></li>
						<%-- <li><a href="<%=rootPath%>/wms/product/toProductView.do">产品选购</a></li>
						<li><a href="<%=rootPath%>/wms/order/orderList.do">订单列表</a></li> --%>
					</ul>
