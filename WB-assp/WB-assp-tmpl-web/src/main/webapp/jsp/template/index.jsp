...
<title>${siteTempalte.templateName }</title>
<script type="text/javascript">
    var rootPath = '<%= rootPath%>';
</script>
 <jsp:include page="/jsp/common/commonCssLink.jsp"></jsp:include> 
 <jsp:include page="/jsp/common/commonTemplateJs.jsp"></jsp:include> 

<c:if test="${columnsId != null }">
       <script type="text/javascript">
...
<link rel="stylesheet" href="http://1.202.135.37/wms/template/${siteTempalte.templateCode }/css/self.css" />
<script src="<%=rootPath%>/static/layer/layer.js" type="text/javascript"></script> 
</head>

<body class="${siteTempalte.templateCode }">
       <!--建站操作头部-->
