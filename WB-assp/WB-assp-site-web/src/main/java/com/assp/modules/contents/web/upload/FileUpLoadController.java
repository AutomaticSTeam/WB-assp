package com.assp.modules.contents.web.upload;   
			...
			for (MultipartFile file : files) {
				if (file != null && file.getOriginalFilename() != null &&  !"".equals(file.getOriginalFilename())) {
					...
					if (checkFileType(fileName , uploadFileTypes)) {
						...
						String dirFile = remotePath+ siteCode +"/" + dirFolderName  +"/" ;
						uploadVo.setFileServerPath(dirPath+siteCode +"/" + dirFolderName  +"/"+fileName);
