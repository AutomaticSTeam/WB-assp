 ...
 * @version 1.0
 * @CreateDate 2016年4月20日 上午10:16:27 
 */
public class RedisCachedImpl implements ICache{
	
	
	
	private int expire = -1; // -1 - never expire
	...
	@Override
	public Object updateCached(final byte[] key, final byte[] value, final Long expireSec)
			throws Exception {
