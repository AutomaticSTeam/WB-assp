					...
					<div class="login-border">
						...
						<form class="login-form" method="post" action="">
							<div class="form-input-item">
								...
								<input class="user-input" type="text" placeholder="请输入用户名" name="userName" id="userName"    nullmsg=" " autofocus="autofocus"/>
							</div>
							<div class="form-input-item">
							...
							<div class="form-input-item-group">
								...
								<span class="text-code-image" style="line-height: 72px;margin-left: 13px;"><img src="" id="verificationCode" style="width: 92px;height: 38px;"></span>
								<a class="text-code-btn" id="changeVerificationCode" title="点击刷新"></a>
							</div>
							<div class="memory">
								<!-- <span class="radio"><input type="radio" value="" style="display: none;"></span>
								<label>记住密码</label> -->
							</div> 
						<button type="button" class="login-btn" id="login">登录</button></br>
						<p align="center">没有账号？<a href="<%=rootPath%>/jsp/common/login/register.jsp" style="color:#5E9CDC;">请注册</a></p>
						</form>
					</div>
				</div>
			</div><!--主体登录框-->
